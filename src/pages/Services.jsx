  ...
  const services = [
    {
      ...
      title: "UX Design",
      text: "L'UX Design est une discipline qui consiste à concevoir des produits (sites web, applications mobiles, logiciels, objets connectés, etc.) en plaçant l'utilisateur au centre des préoccupations. L'obiectif est de rendre l'expérience utilisateur la plus fluide et agréable possible.",
    },
    {
